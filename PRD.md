...
```css
/* Tema Escuro */
bg-primary: #2F160E      /* Fundo principal */
bg-secondary: #2B130C    /* Fundo de cards */
bg-tertiary: #27110A     /* Fundo de hover */

/* Cores de Texto */
text-primary: #f1f5f9    /* Texto principal */
text-secondary: #EBDCD5  /* Texto secundário */
text-muted: #9A8176      /* Texto menos importante */
```

#### Cores de Estado
```css
success: #2EC47D    /* Verde para entradas/sucesso */
error: #EF3823      /* Vermelho para saídas/erros */
warning: #F5A623    /* Laranja para avisos */
info: #EDF63B       /* Amarelo para informações */
```
...
- **Provedor e Modelo**: API da Groq com o modelo `llama-3.1-8b-instant`.
...
- **RF044**: O chatbot deve utilizar Langchain 1.0 com Groq e modelo `llama-3.1-8b-instant`.
