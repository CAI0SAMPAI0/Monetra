...
- **MonetraBot (Chatbot de Finanças)**: Criação da app `chatbot` que disponibiliza um assistente em tempo real usando Langchain 1.0 e Groq API (`openai/gpt-oss-20b`).
